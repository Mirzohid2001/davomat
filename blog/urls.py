...
urlpatterns = [
    ...
    path('employees/export/', views.employee_list_export, name='employee_list_export'),
    ...
    path('statistics/salary/payments/', views.salary_payment_history_view, name='salary_payment_history'),
    path('statistics/salary/payments/export/', views.export_salary_payment_history_excel, name='salary_payment_history_export'),
    path('statistics/salary/edit/<int:stat_id>/', views.edit_salary_stat, name='edit_salary_stat'),
    path('statistics/salary/loans/create/<int:employee_id>/', views.advance_loan_create, name='advance_loan_create'),
    path('statistics/salary/loans/<int:loan_id>/close/', views.advance_loan_close, name='advance_loan_close'),
    path('statistics/absence-quota/', views.absence_quota_view, name='absence_quota'),
    path('statistics/absence-quota/export/', views.absence_quota_export, name='absence_quota_export'),
    path('statistics/employee/<int:employee_id>/', views.individual_employee_statistics, name='individual_employee_statistics'),
    path('statistics/nalivshik-schedule/', views.nalivshik_schedule_view, name='nalivshik_schedule'),
